      ...
      >
        <div className="px-4 my-auto mx-auto max-w-7xl sm:px-6 lg:px-8">
          <motion.div className="max-w-2xl mx-auto text-center">
            <motion.p className="text-3xl font-semibold leading-tight sm:leading-tight sm:text-3xl md:text-5xl lg:leading-tight" variants={childVariants}>
            ...
            <motion.h1 className="mt-5 px-6 text-md text-offBlack" variants={childVariants}>
              The Electronics and Communication Engineering Student Society (EXCESS) is a non-political umbrella type society registered within the IOE Purwanchal campus, Dharan. It was formed in 2070 B.S.
            </motion.h1>
