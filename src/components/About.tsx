...
const About = () => {
  return (
    <section className="py-10">
      <div className=" w-[90%] sm:w-[85%] md:w-[80%]  flex flex-col-reverse md:flex-row mx-auto m-10 h-4/6 rounded-2xl bg-gradient-to-br from-orange-300  to-white-500  cursor-pointer justify-center">
